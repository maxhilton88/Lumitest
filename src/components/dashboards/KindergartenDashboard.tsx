...
import { LayoutDashboard, Users, Download, Settings, LogOut, BarChart3, Menu, MessageCircle, Zap, Target, ArrowRight, Link2, Megaphone, Eye, CheckCircle2, RefreshCw, ExternalLink, Clock, Send } from 'lucide-react';
...
import { loadLeads, createShareableReport, getReportStatus, fetchLiveQuests, fetchSchoolReferralSources } from '../../utils/api';
                            ...
                            <AreaChart data={chartData} margin={{ top: 5, right: 5, left: -20, bottom: 0 }}>
                              ...
                              <Tooltip
                                ...
                                labelFormatter={(label: string) => {
                                  const match = chartData.find(d => d.month === label);
                                  return match?.fullMonth || label;
                                }}
                              />
                              <Area
                                type="monotone"
