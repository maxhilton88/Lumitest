...
export const EarningsHub: React.FC<EarningsHubProps> = ({ parentData, scrollToShare, onScrollToShareDone }) => {
  ...
  const referralLink = referralCode
    ? `https://foxy.projectlumi.org/?ref=${referralCode}`
    : '';
      ...
      {referralNetwork && (
        ...
        <FantasyPanel className="p-5">
          ...
          <div className="grid grid-cols-2 gap-3 mb-4">
            ...
            >
              <p className="text-xl font-bold" style={{ color: GOLD_LIGHT, fontFamily: "'Cinzel Decorative', serif" }}>
            ...
            <div
              ...
              style={{ background: `${GOLD}08`, border: `1.5px solid ${GOLD}15` }}
            >
              <p className="text-xl font-bold" style={{ color: '#7cc643', fontFamily: "'Cinzel Decorative', serif" }}>
