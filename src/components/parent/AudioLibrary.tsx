...
// ===== COMPONENT =====
export const AudioLibrary: React.FC<AudioLibraryProps> = ({ parentData, onShowUpgrade }) => {
  const { t } = useLanguage();
  ...
  }, [repeatMode, shuffleOn, queueIndex, queue, currentTrack]);
            ...
            <div className="flex-1 flex flex-col items-center justify-center px-6 gap-6">
              ...
              <div className="text-center w-full">
                <h2
                  ...
                  style={{ color: GOLD_LIGHT, fontFamily: CINZEL, textShadow: `0 2px 8px rgba(0,0,0,0.6)` }}
                >
                  {currentTrack.title}
                </h2>
