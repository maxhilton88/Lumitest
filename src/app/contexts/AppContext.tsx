...
export interface AppContextValue {
  ...
  setExcludedSubjects: (v: string[]) => void;
  completedModules: string[];
  currentModule: string;
  currentQuestionIndex: number;
  currentTestQuestions: Question[];
  allDetailedAnswers: DetailedAnswer[];
  setAllDetailedAnswers: React.Dispatch<React.SetStateAction<DetailedAnswer[]>>;
  currentModuleAnswers: DetailedAnswer[];
  moduleResults: Record<string, { score: number; total: number }>;
  setModuleResults: React.Dispatch<React.SetStateAction<Record<string, { score: number; total: number }>>>;
  ...
  handleLanguageStart: (childName: string, parentName: string, whatsapp: string, selectedAge: number, excludedSubjects: string[]) => Promise<void>;
