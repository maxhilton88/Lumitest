...
import {
  Music, Video, Search, Plus, X, Upload, Loader2, Check, RefreshCw,
  Trash2, Edit3, GripVertical, Star, Lock, Crown, Pencil, Save,
} from 'lucide-react';
...
export const MediaManager: React.FC = () => {
  const [subTab, setSubTab] = useState<'audio' | 'videos' | 'categories'>('audio');
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-1 bg-gray-100 rounded-lg p-0.5">
          ...
          <button
            ...
            className={`flex items-center gap-1.5 px-3 py-1.5 rounded-md text-xs font-medium transition-colors ${
              subTab === 'videos' ? 'bg-white text-gray-900 shadow-sm' : 'text-gray-500 hover:text-gray-700'
            }`}
          >
