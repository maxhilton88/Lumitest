...
interface WhatsAppPromptModalProps {
  ...
  onSkip?: () => void;
  /** Alternative API: control visibility externally */
  isOpen?: boolean;
  /** Alternative API: called on close (skip or complete) */
  onClose?: () => void;
}
...
export const WhatsAppPromptModal: React.FC<WhatsAppPromptModalProps> = ({
  ...
  // Unified skip handler: prefer onSkip, fall back to onClose
  const handleSkip = () => {
    if (onSkip) onSkip();
      ...
      <div className="relative w-full max-w-md animate-in fade-in zoom-in-95 duration-300">
        <FantasyPanel className="p-6 md:p-8">
          ...
          <div className="space-y-3">
            ...
            <button
              onClick={() => { playMenuSelect(); handleSkip(); }}
              disabled={saving}
