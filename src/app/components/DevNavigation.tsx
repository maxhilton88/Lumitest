          ...
          <div className="space-y-2 min-w-[200px]">
            ...
            <div className="pt-2 mt-2 border-t-2 border-gray-200">
              <button
                onClick={() => {
                  playMenuSelect();
                  navigate('/dyntube-test');
                  setIsOpen(false);
                }}
                className="w-full flex items-center gap-3 p-3 rounded-2xl font-bold bg-purple-100 text-purple-700 hover:bg-purple-200 transition-all"
              >
                <Video className="w-5 h-5" />
                <span className="text-sm">DynTube Test</span>
              </button>
            </div>
          </div>
        </div>
