...
export const SpiderWebChart: React.FC<SpiderWebChartProps> = ({
  ...
  // Guard: recharts generates null keys when data is empty or has < 3 points for radar
  if (!data || data.length < 3) {
    return (
      <div className="w-full flex items-center justify-center" style={{ maxWidth, margin: '0 auto', height: chartHeight }}>
        <p style={{ color: isLight ? '#9ca3af' : 'rgba(200,184,138,0.5)', fontSize: 12 }}>
